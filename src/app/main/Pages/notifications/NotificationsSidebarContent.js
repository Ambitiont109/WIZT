...
class NotificationsSidebarContent extends Component {
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(NotificationsSidebarContent)));

...
class LabelsHeader extends Component {
                ...
                <div className="flex flex-shrink items-center sm:w-224">
                    ...
                    <div className="flex items-center">
                        <FuseAnimate animation="transition.expandIn" delay={300}>
                            <Icon className="text-32 mr-12">format_align_left</Icon>
                        </FuseAnimate>
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Typography variant="h6" className="hidden sm:flex">Labels</Typography>
                        </FuseAnimate>
                    </div>
                </div>
...
function mapStateToProps({labelsApp, fuse})
{
    return {
...
export default connect(mapStateToProps, mapDispatchToProps)(LabelsHeader);

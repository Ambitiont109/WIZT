...
class FloorPlansHeader extends Component {
...
function mapStateToProps({floorplansApp, fuse})
{
    return {
...
export default connect(mapStateToProps, mapDispatchToProps)(FloorPlansHeader);

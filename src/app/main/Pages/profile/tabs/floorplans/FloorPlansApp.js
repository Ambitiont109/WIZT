...
class FloorPlansApp extends Component {
...
export default withReducer('floorplansApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(FloorPlansApp))));

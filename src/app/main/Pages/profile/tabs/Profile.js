...
import { AppBar, Card, CardContent, Icon, Toolbar, Typography, Avatar} from '@material-ui/core';
                            ...
                            <Card className="w-full mb-16">
                                ...
                                <CardContent>
                                    ...
                                    <div className="mb-24">
                                        ...
                                        {/* <Typography>{email_verified}</Typography> */}
                                    </div>
                                    <div className="mb-24">
                                    ...
                                    <div className="mb-24">
                                        ...
                                        <Typography>{phone_number_verified}</Typography>
                                    </div>
                                </CardContent>
                            </Card>
                        )}
